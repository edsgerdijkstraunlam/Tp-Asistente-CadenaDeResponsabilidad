...
*/
	...
	public void testChuckNorrisFacts(){
		...
		Assert.assertEquals(jenkins.getUsuario() +" Cuando el apocalipsis zombie empieze, Chuck Norris no va a tratar de sobrevivir. Los zombies sí.", jenkins.escuchar("Me contas un Chuck Norris Facts"));
